...
public class GoldenSyharic extends Item {
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        ...
        components.add(new TranslatableComponent("mchips.description.golden_syharic.1").withStyle(ChatFormatting.RED));
        components.add(new TranslatableComponent("mchips.description.golden_syharic.2").withStyle(ChatFormatting.GREEN));
    }
}
