...
public class PotatoSyharic extends Item {
    public static final Food POTATO_SYHARIC = new Food.Builder()
            .nutrition(12)
            .saturationMod(6)
            .effect(() -> new EffectInstance(Effects.HEAL, 1, 20, false, false), 1.0F)
            .build();
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable World world, List<ITextComponent> components, ITooltipFlag flag) {
        ...
        components.add(new TranslationTextComponent("mchips.description.potato_syharic").withStyle(TextFormatting.GREEN));
    }
}
